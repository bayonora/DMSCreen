  ...
  return (
    <div className="flex-1 flex flex-col bg-transparent border-none rounded-none overflow-hidden">
      {selectedMap ? (
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden bg-[#0a0a09]">
          {/* MAPS GALLERY */}
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
              {locations.map((loc) => (
                <div key={loc.id} className="bg-[#1e1a17] border border-[#3a302a] flex flex-col cursor-pointer shadow-lg shadow-black/50 hover:border-[#c1a063] transition-colors group" onClick={() => setSelectedLocationId(loc.id)}>
                  ...
                  <div className="p-3 bg-[#1e1a17]">
                    <div className="text-xs text-[#e6e2da] uppercase tracking-widest truncate font-bold">{loc.name}</div>
